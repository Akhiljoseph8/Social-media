      ...
      <Card sx={{ maxWidth: 400, padding: 3, boxShadow: 3 }}>
        <CardContent>
          <Grid container justifyContent="center" mb={2}>
            <img src="https://cdn-icons-png.flaticon.com/512/295/295128.png" alt="auth" width={60} />
          </Grid>
          <Typography variant="h5" gutterBottom>{status ? "Login" : "Register"}</Typography>
          {!status && (
          ...
          />
          {!status && (
            <TextField fullWidth margin="normal" label="Phone" type="number" variant="outlined" 
          ...
          <Grid container justifyContent="space-between" alignItems="center" mt={2}>
            <Button variant="contained" color="primary" onClick={status ? handleLogin : handleRegister}>
